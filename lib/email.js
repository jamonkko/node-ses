...
>>>>>>> f35ca62df16a809a354a0ad9a82e8e052ec4c7d2
...
=======
    ...
    request(signedOpts, function (err, res, data) {
        resolve(self._processResponse(err, res, data));
    });
  });
>>>>>>> f35ca62df16a809a354a0ad9a82e8e052ec4c7d2
};
 ...
 *
 */
Email.prototype._processResponse = function _processResponse (err, res, data) {
  ...
  return new Promise(function(resolve, reject) {
    if (res.statusCode < 200 || res.statusCode >= 400) {
      return xmlParser.parseString(data,function(err,result){
          ...
          reject(result.ErrorResponse.Error);
      });
    }
